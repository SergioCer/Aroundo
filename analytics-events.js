...
async function updateAnalytics(values){
  ...
  if(data && data.length){
    ...
    export function analyticsGPS(value,lat=null,lng=null){return updateAnalytics({gps:value,lat:lat!==null?Number(lat.toFixed(2)):
                    undefined,lng:lng!==null?Number(lng.toFixed(2)):undefined});}

(function () {
  ...
  it: {
    ...
    categoriesText1: "Vengono tolte tutte le catogorie.<br>Lasciandoti scegliere solo le tue.<br>Come noti sono spariti tutti gli eventi! ma non preoccuparti.",
    ...
    categoriesText3: "Seleziona le tue scelte.<br>Appariranno solo gli eventi corrispondenti a quelle categorie.",
    categoriesTitle4: "Se hai fatto una selezione.",
    categoriesText4: "Verrà mantenuta.<br>E fino a quando non cambi, vedrai solo gli eventi della tua selezione.",
    categoriesTitle5: "Riaprendo infatti...",
    categoriesText5: "Troverai la tua selezione.<br>Se vuoi puoi reimpostare tutte le categorie con un solo click.",

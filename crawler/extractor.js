...
if(requestUrl.pathname==="/"&&!requestUrl.searchParams.has("url")){res.writeHead(200,{"Content-Type":"text/html; charset=utf-8"});
return res.end(fs.readFileSync(__dirname+"/crawler.html"));}res.setHeader("Content-Type","application/json; charset=utf-8");
